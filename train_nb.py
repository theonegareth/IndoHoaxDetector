"""
Train Multinomial Naive Bayes with TF-IDF for IndoHoaxDetector comparison.

This script trains a Multinomial Naive Bayes classifier on the same preprocessed data and TF-IDF features
as the Logistic Regression, SVM, and Random Forest models, for performance comparison.
...
DEFAULT_MODEL_PATH = "nb_model.pkl"
...
def train_nb_on_labeled(
    ...
    # Save model
    print(f"[INFO] Saving Naive Bayes model to: {model_path}")
...
def main():
    ...
    # Train Naive Bayes
    model = train_nb_on_labeled(
        df=df,
        vectorizer=vectorizer,
        model_path=model_path,
    )

    print(f"\n[INFO] Naive Bayes training complete. Model saved to {model_path}")
